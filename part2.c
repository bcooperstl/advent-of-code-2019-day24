...
E: [0][0][4] has 4 neighbors  8 [-1][1][2],  D  [0][0][3], 14 [-1][2][4],  J  [0][1][4]
...
J: [0][1][4] has 4 neighbors  E  [0][0][4],  I  [0][1][3], 14 [-1][2][4],  O  [0][2][4]
...
O: [0][2][4] has 4 neighbors  J  [0][1][4],  N  [0][2][3], 14 [-1][2][4],  T  [0][3][4]
...
T: [0][3][4] has 4 neighbors  O  [0][2][4],  S  [0][3][3], 14 [-1][2][4],  Y  [0][4][4]
...
Y: [0][4][4] has 4 neighbors  T  [0][3][4],  X  [0][4][3], 14 [-1][2][4], 18 [-1][3][2]
*/
...
void workWorld(world * w)
{
    ...
    for (int i=1; i<ALL_DEPTHS-1; i++) // work through all of the possible worlds where we would have bugs.
    {
        ...
        num_adjacent[0][4]=bugVal(tmp.grids[i-1].map[1][2]) + bugVal(tmp.grids[i].map[0][3])   + bugVal(tmp.grids[i-1].map[2][4]) + bugVal(tmp.grids[i].map[1][4]);
        ...
        num_adjacent[1][4]=bugVal(tmp.grids[i].map[0][4])   + bugVal(tmp.grids[i].map[1][3])   + bugVal(tmp.grids[i-1].map[2][4]) + bugVal(tmp.grids[i].map[2][4]);
        ...
        num_adjacent[2][4]=bugVal(tmp.grids[i].map[1][4])   + bugVal(tmp.grids[i].map[2][3])   + bugVal(tmp.grids[i-1].map[2][4]) + bugVal(tmp.grids[i].map[3][4]);
        ...
        num_adjacent[3][4]=bugVal(tmp.grids[i].map[2][4])   + bugVal(tmp.grids[i].map[3][3])   + bugVal(tmp.grids[i-1].map[2][4]) + bugVal(tmp.grids[i].map[4][4]);
        ...
        num_adjacent[4][4]=bugVal(tmp.grids[i].map[3][4])   + bugVal(tmp.grids[i].map[4][3])   + bugVal(tmp.grids[i-1].map[2][4]) + bugVal(tmp.grids[i-1].map[3][2]);
        ...
        for (int j=0; j<5; j++)
        {
            for (int k=0; k<5; k++)
            {
                ...
                {
                    printf("clearing bug at depth %d [%d][%d]\n", i, j, k);
                ...
                {
                    printf("creating bug at depth %d [%d][%d]\n", i, j, k);
